...
public delegate void ShowSkillText(int tag, string content);
public delegate void SetTimeText(string second);
public delegate void SeCurrentHp(int tag, int hp);
// 全局配置。不放场景中，通过脚本创建。
public class UIManager : MonoBehaviour
{
    ...
    private Transform Parent
    {
        ...
        {
            if (_parent == null)
                _parent = transform.Find("LobbyCanvas").transform;
            return _parent;
        }
    }
    ...
    private Transform Top
    {
        ...
        {
            if (_top == null)
                _top = transform.Find("TopCanvas").transform;
            return _top;
        }
    }
    ...
    public static SeCurrentHp doSetCurrentHp;
